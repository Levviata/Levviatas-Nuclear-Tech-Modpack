...
crafting.shapedBuilder()
        .name(resource('refinedstorage:wireless_fluid_grid'))
        .output(item('refinedstorage:wireless_fluid_grid'))
        .row('ABA')
        .row('ACA')
        .row('ADA')
        .key('A', item('hbm:ingot_steel'))
        .key('B', item('minecraft:ender_pearl'))
        .key('C', item('refinedstorage:grid', 3))
        .key('D', item('refinedstorage:processor', 5))
        .replaceByName()
        .register()
...
crafting.shapedBuilder()
        ...
        .row('ACA')
        .key('A', item('hbm:ingot_steel'))
        .key('B', item('refinedstorage:processor:5'))
        .key('C', ore('itemSilicon'))
        .key('D', item('refinedstorage:machine_casing'))
        .replaceByName()
        .register()
...
crafting.shapedBuilder()
        ...
        .key('A', ore('blockGlass'))
        .key('B', item('minecraft:redstone'))
        .key('C', item('refinedstorage:storage_part:3'))
        .key('D', item('hbm:ingot_steel'))
        .replaceByName()
        .register()
...
crafting.shapedBuilder()
        .name(resource('refinedstorage:64k_fluid_storage_part'))
        .output(item('refinedstorage:fluid_storage_part'))
        .row('ABA')
        .row('CDC')
        .row('ACA')
        .key('A', ore('itemSilicon'))
        .key('B', item('hbm:ingot_steel'))
        .key('C', ore('blockGlass'))
        .key('D', item('minecraft:bucket'))
        .replaceByName()
        .register()

crafting.shapedBuilder()
        .name(resource('refinedstorage:64k_fluid_storage_disk'))
        .output(item('refinedstorage:fluid_storage_disk'))
        .row('ABA')
        .row('BCB')
        .row('DDD')
        .key('A', ore('blockGlass'))
        .key('B', item('minecraft:redstone'))
        .key('C', item('refinedstorage:fluid_storage_part'))
        .key('D', item('hbm:ingot_steel'))
        .replaceByName()
        .register()

crafting.shapedBuilder()
        .name(resource('refinedstorage:64k_fluid_storage_block'))
        .output(item('refinedstorage:fluid_storage'))
        .row('ABA')
        .row('ACA')
        .row('ADA')
        .key('A', item('hbm:ingot_steel'))
        .key('B', item('refinedstorage:fluid_storage_part'))
        .key('C', item('refinedstorage:machine_casing'))
        .key('D', item('minecraft:redstone'))
        .replaceByName()
        .register()
...
crafting.shapedBuilder()
        ...
        .key('B', item('hbm:ingot_polymer'))
        .key('C', item('refinedstorage:storage_part:1'))
        .key('D', item('hbm:ingot_steel'))
        .replaceByName()
        .register()
...
crafting.shapedBuilder()
        .name(resource('refinedstorage:4096k_fluid_storage_part'))
        .output(item('refinedstorage:fluid_storage_part:3'))
        .row('ABA')
        .row('CDC')
        .row('ACA')
        .key('A', item('refinedstorage:processor:5'))
        .key('B', item('hbm:ingot_steel'))
        .key('C', item('refinedstorage:fluid_storage_part:2'))
        .key('D', item('minecraft:bucket'))
        .replaceByName()
        .register()

crafting.shapedBuilder()
        .name(resource('refinedstorage:4096k_fluid_storage_disk'))
        .output(item('refinedstorage:fluid_storage_disk:3'))
        .row('ABA')
        .row('BCB')
        .row('DDD')
        .key('A', item('hbm:glass_uranium'))
        .key('B', item('hbm:ingot_polymer'))
        .key('C', item('refinedstorage:fluid_storage_part:3'))
        .key('D', item('hbm:ingot_steel'))
        .replaceByName()
        .register()

crafting.shapedBuilder()
        .name(resource('refinedstorage:4096k_fluid_storage_block'))
        .output(item('refinedstorage:fluid_storage:3'))
        .row('ABA')
        .row('ACA')
        .row('ADA')
        .key('A', item('hbm:ingot_steel'))
        .key('B', item('refinedstorage:fluid_storage_part:3'))
        .key('C', item('refinedstorage:machine_casing'))
        .key('D', item('minecraft:redstone'))
        .replaceByName()
        .register()
...
crafting.shapedBuilder()
        .name(resource('refinedstorage:256k_fluid_storage_part'))
        .output(item('refinedstorage:fluid_storage_part:1'))
        .row('ABA')
        .row('CDC')
        .row('ACA')
        .key('A', item('refinedstorage:processor:3'))
...
crafting.shapedBuilder()
        .name(resource('refinedstorage:256k_fluid_storage_disk'))
        .output(item('refinedstorage:fluid_storage_disk:1'))
        .row('ABA')
        .row('BCB')
        .row('DDD')
        .key('A', item('hbm:glass_uranium'))
        .key('B', item('hbm:ingot_polymer'))
        .key('C', item('refinedstorage:fluid_storage_part:1'))
        .key('D', item('hbm:ingot_steel'))
        .replaceByName()
        .register()

crafting.shapedBuilder()
        .name(resource('refinedstorage:256k_fluid_storage_block'))
        .output(item('refinedstorage:fluid_storage:1'))
        .row('ABA')
        .row('ACA')
        .row('ADA')
        .key('A', item('hbm:ingot_steel'))
        .key('B', item('refinedstorage:fluid_storage_part:1'))
        .key('C', item('refinedstorage:machine_casing'))
        .key('D', item('minecraft:redstone'))
        .replaceByName()
        .register()
...
crafting.shapedBuilder()
        .name(resource('refinedstorage:1024k_fluid_storage_part'))
        .output(item('refinedstorage:fluid_storage_part:2'))
        .row('ABA')
        .row('CDC')
        .row('ACA')
        .key('A', item('refinedstorage:processor:4'))
...
crafting.shapedBuilder()
        .name(resource('refinedstorage:1024k_fluid_storage_disk'))
        .output(item('refinedstorage:fluid_storage_disk:2'))
        .row('ABA')
        .row('BCB')
        .row('DDD')
        .key('A', item('hbm:glass_uranium'))
...
crafting.shapedBuilder()
        .name(resource('refinedstorage:1024k_fluid_storage_block'))
        .output(item('refinedstorage:fluid_storage:2'))
        .row('ABA')
        .row('ACA')
        .row('ADA')
        .key('A', item('hbm:ingot_steel'))
        .key('B', item('refinedstorage:fluid_storage_part:2'))
        .key('C', item('refinedstorage:machine_casing'))
        .key('D', item('minecraft:redstone'))
        .replaceByName()
        .register()
