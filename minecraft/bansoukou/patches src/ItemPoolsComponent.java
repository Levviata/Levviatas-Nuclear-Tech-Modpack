...
//
// added or tweaked:
// from POOL_SOLID_FUEL
//                    weighted(ModItems.solid_fuel, 0, 1, 5, 2),
//                    weighted(ModItems.rocket_fuel, 0, 1, 5, 1),
//                    weighted(ModItems.solid_fuel_presto, 0, 1, 3, 2),
//                    weighted(ModItems.ball_tatb, 0, 1, 4, 2),
//                    weighted(ModItems.ball_tnt, 0, 1, 4, 2),
//                    weighted(Items.REDSTONE, 0, 1, 8, 3),
//                    weighted(ModItems.niter, 0, 1, 12, 1)
//  from POOL_NUKE_FUEL
//                    weighted(ModItems.pile_rod, 3, 2, 5, 3),
//                    weighted(ModItems.pile_rod, 4, 2, 5, 3),
//                    weighted(ModItems.pile_rod, 0, 1, 2, 2),
//                    weighted(ModItems.pile_rod, 1, 1, 2, 2),
//                    weighted(ModItems.screwdriver, 0, 1, 1, 2),
//                    weighted(ModItems.screwdriver_desh, 0, 1, 1, 2),
//                    weighted(ModItems.defuser_desh, 0, 1, 1, 2)
// from POOL_VAULT_LAB
//                    weighted(ModItems.powder_iodine, 0, 1, 4, 1),
//                    weighted(ModItems.powder_bromine, 0, 1, 4, 1),
//                    weighted(ModItems.powder_cobalt, 0, 1, 4, 1),
//                    weighted(ModItems.powder_neodymium, 0, 1, 4, 1),
//                    weighted(ModItems.powder_boron, 0, 1, 4, 1)
// removed:
// from POOL_OFFICE_TRASH
    ...
    public static void init() {
        ...
        new ItemPool(POOL_VAULT_LAB) {{
            this.pool = new WeightedRandomChestContentFrom1710[] {
                    ...
                    weighted(ModItems.screwdriver_desh, 0, 1, 1, 9),
                    weighted(ModItems.ingot_mercury, 0, 1, 4, 3),
                    weighted(ModItems.morning_glory, 0, 1, 1, 1),
                    weighted(ModItems.filter_coal, 0, 1, 1, 5),
                    weighted(ModItems.dust, 0, 1, 1, 25),
                    weighted(Items.PAPER, 0, 1, 6, 15),
